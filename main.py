...
def inicio():
    return {
        ...
        "version": "2.3",
        "database": "Memoria (Portfolio Mode)",
        "endpoints": ["/productos", "/api/pedidos", "/docs"],
        "status": "online",
        "pedidos_actuales": len(pedidos_en_memoria)
    }
...
def obtener_productos():
    try:
        productos = [
            {"id": 1, "nombre": "Manzanas Golden", "categoria": "frutas", "precio": 2.25, "stock": 100, "unidad": "kg",
             "imagen": "img/golden.webp", "descripcion": "Manzanas dulces y crujientes de temporada"},
            {"id": 2, "nombre": "Manzanas Pink Lady", "categoria": "frutas", "precio": 3.75, "stock": 100,
             "unidad": "kg", "imagen": "img/pink_lady.webp",
             "descripcion": "Manzanas dulces y crujientes de temporada"},
            {"id": 3, "nombre": "Manzanas Reineta", "categoria": "frutas", "precio": 2.95, "stock": 100, "unidad": "kg",
             "imagen": "img/manzana_reineta.webp", "descripcion": "Manzanas dulces y crujientes de temporada"},
            {"id": 4, "nombre": "Manzanas Ambrosia", "categoria": "frutas", "precio": 3.75, "stock": 100,
             "unidad": "kg", "imagen": "img/ambrosia.webp", "descripcion": "Manzanas dulces y crujientes de temporada"},
            {"id": 5, "nombre": "Manzanas Granny Smith", "categoria": "frutas", "precio": 2.85, "stock": 100,
             "unidad": "kg", "imagen": "img/granny_smit.webp",
             "descripcion": "Manzanas dulces y crujientes de temporada"},
            {"id": 6, "nombre": "Naranjas Mutxamel", "categoria": "frutas", "precio": 2.25, "stock": 200,
             "unidad": "kg", "imagen": "img/naranja_mesa.jpeg",
             "descripcion": "Naranjas de Mutxamel jugosas, perfectas para zumo"},
            {"id": 7, "nombre": "Naranja Zumo", "categoria": "frutas", "precio": 1.65, "stock": 100, "unidad": "kg",
             "imagen": "img/naranja_zumo.jpg", "descripcion": "Naranjas dulces y con mucho zumo de temporada"},
            {"id": 8, "nombre": "Plátanos de Canarias", "categoria": "frutas", "precio": 1.80, "stock": 120,
             "unidad": "kg", "imagen": "img/Platano.jpg", "descripcion": "Plátanos de Canarias maduros y dulces"},
            {"id": 9, "nombre": "Tomates Pera", "categoria": "verduras", "precio": 2.25, "stock": 90, "unidad": "kg",
             "imagen": "img/tomate_pera.jpg", "descripcion": "Tomates frescos de la huerta"},
            {"id": 10, "nombre": "Tomates Rama", "categoria": "verduras", "precio": 2.25, "stock": 90, "unidad": "kg",
             "imagen": "img/tomate_rama.png", "descripcion": "Tomates frescos de la huerta"},
            {"id": 11, "nombre": "Tomates Daniela", "categoria": "verduras", "precio": 2.25, "stock": 90,
             "unidad": "kg", "imagen": "img/tomate_Daniela.jpg", "descripcion": "Tomates frescos de la huerta"},
            {"id": 12, "nombre": "Tomates Raff", "categoria": "verduras", "precio": 8.95, "stock": 90, "unidad": "kg",
             "imagen": "img/tomate_raf.webp", "descripcion": "Tomates frescos de la huerta"},
            {"id": 13, "nombre": "Tomate Azul", "categoria": "verduras", "precio": 6.75, "stock": 90, "unidad": "kg",
             "imagen": "img/Tomate-azul.jpg", "descripcion": "Tomates frescos de la huerta"},
            {"id": 14, "nombre": "Tomate Rosa", "categoria": "verduras", "precio": 4.85, "stock": 90, "unidad": "kg",
             "imagen": "img/tomate_rosa.webp", "descripcion": "Tomates frescos de la huerta"},
            {"id": 15, "nombre": "Tomate Mutxamel", "categoria": "verduras", "precio": 2.65, "stock": 90,
             "unidad": "kg", "imagen": "img/tomate_mtx.webp", "descripcion": "Tomates frescos de la huerta"},
            {"id": 16, "nombre": "Lechuga Romana", "categoria": "verduras", "precio": 1.50, "stock": 73, "unidad": "ud",
             "imagen": "img/lechuga_romana.jpg", "descripcion": "Lechugas frescas recién cosechadas"},
            {"id": 17, "nombre": "Lechuga Iceberg", "categoria": "verduras", "precio": 1.35, "stock": 90,
             "unidad": "ud", "imagen": "img/lechuga_icebrg.jpg", "descripcion": "Lechugas frescas de la huerta"},
            {"id": 18, "nombre": "Lechuga Corazones", "categoria": "verduras", "precio": 1.00, "stock": 90,
             "unidad": "ud", "imagen": "img/corazon_lechuga.jpg", "descripcion": "Corazones de lechuga tiernos"},
            {"id": 19, "nombre": "Lechuga Hoja de Roble", "categoria": "verduras", "precio": 2.20, "stock": 90,
             "unidad": "ud", "imagen": "img/lechuga_roble.jpg", "descripcion": "Lechuga hoja de roble fresca"},
            {"id": 20, "nombre": "Fresas", "categoria": "frutas", "precio": 7.25, "stock": 60, "unidad": "kg",
             "imagen": "img/fresas.jpg", "descripcion": "Fresas dulces y aromáticas de temporada"},
            {"id": 21, "nombre": "Aguacates", "categoria": "frutas", "precio": 2.25, "stock": 45, "unidad": "ud",
             "imagen": "img/aguacate.webp", "descripcion": "Aguacates cremosos perfectos para ensaladas"},
            {"id": 22, "nombre": "Pimiento Verde", "categoria": "verduras", "precio": 1.10, "stock": 80, "unidad": "ud",
             "imagen": "img/pimiento_verde.jpg", "descripcion": "Pimientos verdes de la huerta"},
            {"id": 23, "nombre": "Pimiento Rojo", "categoria": "verduras", "precio": 1.10, "stock": 80, "unidad": "ud",
             "imagen": "img/pimiento_rojo.jpg", "descripcion": "Pimientos rojos de la huerta"},
            {"id": 24, "nombre": "Pimiento Amarillo", "categoria": "verduras", "precio": 1.85, "stock": 80,
             "unidad": "ud", "imagen": "img/pimiento_amarillo.jpg", "descripcion": "Pimientos amarillos de la huerta"},
            {"id": 25, "nombre": "Zanahorias", "categoria": "verduras", "precio": 1.60, "stock": 150, "unidad": "kg",
             "imagen": "img/zanahorias.jpg", "descripcion": "Zanahorias frescas y crujientes"},
            {"id": 26, "nombre": "Sandías (7kg aprx)", "categoria": "frutas", "precio": 1.25, "stock": 30,
             "unidad": "kg", "imagen": "img/sandia.jpg", "descripcion": "Sandías jugosas y refrescantes"},
            {"id": 27, "nombre": "Melón bollo (5kg aprx)", "categoria": "frutas", "precio": 4.25, "stock": 30,
             "unidad": "kg", "imagen": "img/bollo_bodega.jpeg",
             "descripcion": "Melones tan dulces como el algodón de azúcar"},
            {"id": 28, "nombre": "Melón Terreno (5kg aprx)", "categoria": "frutas", "precio": 2.50, "stock": 30,
             "unidad": "kg", "imagen": "img/melon.png", "descripcion": "Melón de cercanía, refrescante y crujiente"},
        ]
...
def health_check():
    return {
        "status": "ok",
        "database": "memoria",
        "pedidos_guardados": len(pedidos_en_memoria),
